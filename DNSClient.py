...
def query_local_dns_server(domain, question_type):
    ...
    answers = resolver.resolve(domainList[0], 'A')  # provide the domain and question_type
...
def exfiltrate_info(domain, question_type): # testing method for part 2
    data = query_local_dns_server(domainList,'A')
    return data
...
print(exfiltrate_info(domainList, question_type))
